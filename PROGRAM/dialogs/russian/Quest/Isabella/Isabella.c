...
//************************************ новая жизнь бывшего корсара ********************************
		...
		case "NewLife_JustTalk":
			if (CheckAttribute(pchar, "RomanticQuest.Atilla"))
			{
				...
				{
					case "YouAreSwine":
						dialog.text = pchar.name + ", до меня дошли ужасные слухи... будто ты даже не отблагодарил своего друга Атиллу, и это после всего, что он для нас сделал! Без его помощи мы бы сейчас не были вместе...";
						link.l1 = "Гм, я как-то даже и не задумывался об этом...";
						link.l1.go = "NewLife_exit";
					break;
					case "YouAreBaster": 
