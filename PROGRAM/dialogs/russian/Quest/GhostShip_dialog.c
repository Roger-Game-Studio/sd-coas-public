...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "GhostCapt_Prize1":
			dialog.text = "Да... немногие, даже из тех, кто видел меня живым, узнали бы сейчас старину Ван дер Декена...";
			link.l1 = "Так ты и есть легендарный капитан 'Летучего Голландца' Ван дер Декен?!";
		...
		case "GhostCapt_LastDialog":
			...
			link.l1 = " Я " + GetSexPhrase("пришел","пришла") + " освободить тебя и твоих людей от проклятия. Твоё время вышло - пора на покой, гроза морей и капитан призрака Ван дер Декен.";
