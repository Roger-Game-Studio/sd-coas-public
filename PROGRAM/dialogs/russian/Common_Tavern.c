...
void ProcessDialogEvent()
{
	...
	////////////////////////////////////////////////////////=============================================///////////////////////////////////////////////////////	
        case "int_quests":
			...
			if(CheckAttribute(pchar, "questTemp.pirateStartQuest") && pchar.questTemp.pirateStartQuest == "1" && GetArealByCityName(npchar.city) == pchar.questTemp.pirateStartQuest.Areal && npchar.city != pchar.questTemp.pirateStartQuest.City)
			{
				...
				else
				{
					...
					{
						link.l12 = "Принес я тебе 1000 пиастров. Говори что знаешь.";
		...
		case "pirateStartQuest_Tavern_1":
			dialog.text = "Хм, ну что ж, может что-то и знаю... Но забесплатно говорить не буду, я благотворительностью не занимаюсь. Моя информация стоит 1000 пиастров. Плати или уходи.";
			if (sti(pchar.money) >= 1000)
			{
				link.l1 = "Хорошо, вот тебе 1000 пиастров... Говори что знаешь.";
