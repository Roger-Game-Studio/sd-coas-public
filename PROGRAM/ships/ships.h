...
#define SHIP_TYPES_QUANTITY					32
#define SHIP_TYPES_QUANTITY_WITH_FORT		33	// must be (SHIP_TYPES_QUANTITY + 1)
...
#define SHIP_FRIGATEQUEEN		27
#define SHIP_SANTISIMA		    28
#define SHIP_LUGGERQUEST               29
