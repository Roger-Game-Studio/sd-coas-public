...
#define INTERFACE_CHARACTER				2  // просмотр Ќѕ— и выбор специал
...
#define INTERFACE_FOR_TEST  			19  // дл€ тестов
...
// Warship -->
#define INTERFACE_BEST_MAP			50	// »нтерфейс отличной карты
#define INTERFACE_TAVERN_WAIT			51	// »нтерфейс отдыха
#define INTERFACE_GOODS_TRANSFER		52	// »нтерфейс закупки товара казначеем
// <-- Warship
// Ugeen -->
#define INTERFACE_MAPVIEW				53 // »нтерфейс атласа карт 
#define INTERFACE_STORAGE				54 // »нтерфейс склада
// <-- Ugeen
...
#define RC_INTERFACE_RANSACK_MAIN_EXIT			45026 // нужно, используетс€ в сиадог.с
...
// boal <--
// Warship -->
#define RC_INTERFACE_BEST_MAP					45076	// »нтерфейс отличной карты
#define RC_INTERFACE_TAVERN_WAIT				45077	// »нтерфейс отдыха
#define RC_INTERFACE_GOODS_TRANSFER				45078	// »нтерфейс закупки товара казначеем
// <-- Warship
// Ugeen -->
#define RC_INTERFACE_MAPVIEW					45079   // »нтерфейс атласа карт 
#define RC_INTERFACE_STORAGE_EXIT				45080   // »нтерфейс склада
// <-- Ugeen
