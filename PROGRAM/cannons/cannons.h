#define CANNON_TYPES_QUANTITY		12
...
#define CANNON_TYPE_CANNON_LBS8	    5
#define CANNON_TYPE_CANNON_LBS12    6
#define CANNON_TYPE_CANNON_LBS16    7
#define CANNON_TYPE_CANNON_LBS24    8
#define CANNON_TYPE_CANNON_LBS32    9
